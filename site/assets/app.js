...
(function () {
  ...
  function methodePage() {
    ...
    return '<div class="wrap"><div class="page-head"><h1 class="page-title">Méthode et sources</h1><p class="page-lede">Ce site restitue des votes publics. Voici d\'où viennent les données, comment les scrutins sont choisis, et ce que les chiffres ne disent pas.</p></div><div class="prose">' +
      ...
      "<h2>2. Ce qui est inclus</h2><p>Tous les <strong>votes publics</strong> du Sénat de la période : votes sur l'ensemble des textes, sur les articles et sur les amendements, ainsi que les motions de procédure. Chaque vote est regroupé par <strong>texte</strong> (dossier législatif).</p><p class='note'>Le rattachement d'un texte à un sujet est automatique (mots-clés du titre) et peut être imparfait pour les textes transversaux : le titre officiel et le dossier législatif restent la référence.</p>" +
